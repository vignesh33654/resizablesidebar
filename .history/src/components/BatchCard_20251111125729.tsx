...
export interface BatchCardProps {
  ...
  timing: string;
  /** Comma-separated educator names */
  educators: string;
      ...
      >
        ...
        <div className="flex flex-col gap-2 w-full">
          ...
          <div className="flex gap-2 items-center">
            <span 
              className="bg-neutral-100 border border-border-primary text-text-primary text-[12px] leading-4 px-1.5 py-0.5 rounded inline-flex items-center justify-center h-[18px] min-w-[26px]"
              aria-label={`Language: ${language}`}
            >
              {language}
            </span>
            <span 
              className="text-primary text-[12px] leading-4 font-normal flex-1 min-w-0"
          ...
          <div className="flex flex-col gap-2">
            {/* Title */}
            <h3 className="text-text-primary text-[16px] leading-6 font-normal tracking-[-0.011em] m-0">
              {title}
            </h3>
            ...
            <div className="flex gap-2 items-center">
              ...
              <p className="text-text-secondary text-[14px] leading-6 font-normal tracking-[-0.006em] flex-1 min-w-0 m-0">
                {startDate}
              </p>
            </div>
