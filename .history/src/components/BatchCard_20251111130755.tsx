        ...
        <div className="flex flex-col gap-[3px] items-center">
          ...
          >
            {educatorImages.slice(0, 2).map((img, idx) => (
              <div 
                key={idx}
                className="bg-primary h-[140px] w-[124px] rounded-[3.676px] overflow-hidden relative shrink-0"
              >
                <img 
                  src={img} 
                  alt={`Educator ${idx + 1}`}
        ...
        <div className="flex flex-col gap-2 w-full">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-2 items-center">
              ...
              <p className="text-secondary text-text-text-body-14 leading-6 font-normal tracking-[-0.006em] flex-1 min-w-0 m-0">
                {timing}
              </p>
            </div>
