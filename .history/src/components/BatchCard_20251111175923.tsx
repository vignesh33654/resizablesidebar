...
>(({ className, asChild = false, href, interactive = false, onClick, children, ...props }, ref) => {
  if (asChild) {
    return (
      <Slot
        ref={ref as never}
        data-slot="batch-card-wrapper"
        className={cn(batchCardWrapperVariants({ interactive: true }), className)}
        {...props}
      >
        {children}
      </Slot>
  ...
  if (href) {
    return (
      <a
        ...
        tabIndex={0}
        className={cn(
          batchCardWrapperVariants({ interactive: true, asLink: true }),
          className
        )}
    ...
    <div
      ...
      className={cn(
        batchCardWrapperVariants({
          interactive: interactive || isButton,
          asButton: isButton,
        }),
        className
      )}
