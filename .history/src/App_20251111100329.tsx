    ...
    <div className="min-h-screen bg-Bg-1 flex items-center justify-center p-8">
      <div className="bg-Bg-0 border border-border-Primary rounded-lg p-3 flex gap-3 max-w-[620px] shadow-sm">
        ...
        <div className="flex flex-col gap-1">
          ...
          <button className="bg-color-primary text-Bg-0 text-font-size-body-14 leading-line-height-body px-3 py-2 rounded font-normal mt-1 self-start hover:opacity-90 transition-opacity">
            Add button
          </button>
        </div>
      </div>
