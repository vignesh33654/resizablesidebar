  ...
  return (
    <div className="min-h-screen bg-Bg-1 flex items-center justify-center p-8">
      <div className="flex gap-4 flex-wrap justify-center max-w-[1200px]">
        ...
        >
          <BatchCard size="compact">
            ...
            <BatchCardContent>
              ...
              <BatchCardMeta>
                <BatchCardTitle>
                  JEE Advanced 2022 Crash Course Batch
                </BatchCardTitle>
                <BatchCardMetaItem>
                  Starts in 1 week · 20 Mar, 2021
                </BatchCardMetaItem>
                <BatchCardMetaItem>
                  Evening classes
                </BatchCardMetaItem>
        ...
        <BatchCard size="wide" className="shadow-lg">
          <BatchCardImage alt="Top educators" />
          <BatchCardContent>
            <BatchCardHeader 
              language="En" 
            ...
            <BatchCardMeta>
              <BatchCardTitle>
                Foundation Course for Class 11th Students
              </BatchCardTitle>
              <BatchCardMetaItem>
                Starts tomorrow · 15 Mar, 2021
              </BatchCardMetaItem>
              <BatchCardMetaItem>
                Flexible timings
              </BatchCardMetaItem>
