  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:ml-(--sidebar-width)",
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-[calc(var(--sidebar-width)+8px)] md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm",
        "md:peer-data-[state=collapsed]:ml-0 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
